...
function knownPlaceIntro(p: MapPlace): string | null {
  ...
  if (/Молчанов/i.test(text)) {
    return 'Молчаново — раннее мокшанское место Антошкиных. Здесь жили Макей Назарович, Антон Макеевич и его сын Кузьма; отсюда семья Антона в 1815 году была переведена в Стерлитамакский уезд, в деревню Татлыбай Балыклы, позднее Кузьминовку.';
  }
  if (/Кузьминовк|Татлыбай|Балыклы/i.test(text)) {
    return 'Кузьминовка встречается в документах и как Татлыбай Балыклы. Сюда пришла линия Антошкиных из Молчанова; здесь фамилия Антошкин закрепляется уже в ревизских сказках. Позже через Кузьминовку эта ветвь соединяется с Лариными и фёдоровским кругом.';
  }
