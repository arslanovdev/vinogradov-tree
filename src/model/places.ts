...
function knownPlaceIntro(p: MapPlace): string | null {
  ...
  if (/Молчанов/i.test(text)) {
    return 'Молчаново — раннее мокшанское место линии Антона Макеевича. Здесь жили Макей, Антон Макеевич и его сыновья Иван, Кузьма и Илья; отсюда семьи сыновей Антона в 1816 году были переведены в Стерлитамакский уезд, в деревню Татлыбай Балыклы / Балаклы, позднее Кузьминовку.';
  }
