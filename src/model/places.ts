...
function knownPlaceIntro(p: MapPlace): string | null {
  ...
  if (/Ф[её]доровк|Нижн[иі]е?\s+Балыкл/i.test(text)) {
    return 'Фёдоровка, прежние Нижние Балыклы, — главный семейный узел этого древа. Село основано между ревизиями 1782 и 1795 годов; ревизия 1795 года — первая для Фёдоровки. Первые 23 семьи пришли через Ново-Никитино, из Армиёва, Стерли и Мукатаева. Здесь сходятся Камышловы, Ларины, Пашины, Бекины и Беловы, но принадлежность наших прямых предков к семьям 1795 года пока не установлена.';
  }
