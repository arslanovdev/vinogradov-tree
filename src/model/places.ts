...
function knownPlaceIntro(p: MapPlace): string | null {
  ...
  if (/Ф[её]доровк|Нижн[иі]е?\s+Балыкл/i.test(text)) {
    return 'Фёдоровка, прежние Нижние Балыклы, — главный семейный узел этого древа. Это старое мордовское селение на реке Балыклы: в конце XVIII века сюда шли переселенцы из пензенско-уфимского мордовского круга, в том числе люди из Алмантаево/Камышлы. Здесь сходятся Камышловы, Ларины, Пашины, Бекины и Беловы, а кузьминовская линия Антошкиных входит в фёдоровский приход через браки и метрики XIX века.';
  }
  if (/Камышл|Алмантаев|Камышлыкулев/i.test(text)) {
    return 'Камышлы — прежняя деревня Алмантаева, она же Камышлыкулева, уфимский мордовский исток Камышловых. В РС 1795 здесь виден кандидатный двор Ивана Моисеева с женой Анной Ивановной и сыном Андреем; именно эта цепочка, если подтвердится РС 1816, объясняет переход фамилии от старого места Камышлы к фёдоровским Камышловым.';
  }
