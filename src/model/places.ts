...
function knownPlaceIntro(p: MapPlace): string | null {
  ...
  if (/Талач|Мокшин/i.test(text)) {
    return 'Талачёво, историческое Талачево-Мокшино, — родное место материнской линии Рахматуллиных. Название деревни связывают с именем Таласа Мирясева: в 1669 году башкиры Мукшинской волости Талас и Супай Мирясевы были припущены вотчинниками Яик-Суби-Минской волости на земли по реке Асаф с ежегодной платой по 4 куницы и одному батману мёда. К началу XIX века в 22 дворах жили 70 башкир и 75 тептярей; X ревизия учла 61 башкира-вотчинника, 218 безземельных башкир и тептярей из татар. В 1875 году селение составляло Талач-Мокшинское общество Верхне-Усинской волости, позднее вошло в Бегеняш-Абукановскую волость Стерлитамакского уезда; рождения жителей записывали в мусульманские метрические книги Стерлитамака. В 1914 году здесь насчитывалось 239 дворов и 1374 жителя, а перепись 1920 года — 274 двора и 1491 жителя, то есть округлённо около 275 дворов и полутора тысяч человек. В годы Великой Отечественной войны из деревни ушли на фронт более 200 человек. Отсюда в XX веке Закарьян Файзуллович переехал в Фёдоровку.';
  }
