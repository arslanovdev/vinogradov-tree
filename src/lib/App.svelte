    ...
    {#if !mobile || legendOpen}
      <div class="legend" class:mobile>
        ...
        <div class="lcol">
          ...
          <div class="lrow"><span style="color:#8d8478">✦</span>&nbsp;военная служба</div>
          <div class="lrow"><span style="color:#a59a8c">✝</span>&nbsp;погиб / умер</div>
        </div>
      </div>
    {/if}
...
<style>
  ...
  .info { position: absolute; left: 16px; bottom: 26px; width: 46px; height: 46px; border-radius: 50%; border: 1px solid #ece5da; background: rgba(255,253,249,0.95); backdrop-filter: blur(8px); font-size: 18px; color: #5b5347; cursor: pointer; box-shadow: 0 6px 18px rgba(70,55,40,0.12); z-index: 45; }
